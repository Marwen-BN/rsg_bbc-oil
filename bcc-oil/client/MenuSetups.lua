...
RegisterNuiCallback('BuyOilWagon', function()
  if not Inmission then --variable is false then
    ...
    RSGCore.Functions.Notify(Config.Language.AlreadyInMission, 'success', 6000) --prints on screen
  end
end)
...
RegisterNuiCallback('SellOilWagon', function()
  if not Inmission then
    ...
    RSGCore.Functions.Notify(Config.Language.AlreadyInMission, 'success', 6000)
  end
end)
